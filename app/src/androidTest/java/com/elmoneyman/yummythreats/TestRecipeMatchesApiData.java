...
public class TestRecipeMatchesApiData {

    static Matcher<View> coloredTextMatch(int leftTextId, String right){
        return new BoundedMatcher<View, TextView>(TextView.class) {
            @Override
            protected boolean matchesSafely(TextView item) {
                if(item.getText()!=null) {
                    String result= RecipeStringUtils.mergeColoredText(item.getContext()
    ...
    static Matcher<View> textAndDisplayMatch(String text){
        return new BoundedMatcher<View, TextView>(TextView.class) {
            @Override
            protected boolean matchesSafely(TextView item) {
    ...
    static Matcher<View> compoundDrawableMatch(final int resourceId){
        return new BoundedMatcher<View, TextView>(TextView.class) {
            @Override
            protected boolean matchesSafely(TextView item) {
